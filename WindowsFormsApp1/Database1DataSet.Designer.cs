...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string Username, string Password, string Email, bool IsAdmin) {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Username] = @Original_Username) AND ([Password" +
                ...
                " = @Original_Email)) AND ([IsAdmin] = @Original_IsAdmin))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Username], [Password], [Email], [IsAdmin]) VALUES (@U" +
                "sername, @Password, @Email, @IsAdmin);\r\nSELECT Username, Password, Email, IsAdmi" +
                "n FROM Users WHERE (Username = @Username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Username] = @Username, [Password] = @Password, [Email] = @Email, [IsAdmin] = @IsAdmin WHERE (([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([IsAdmin] = @Original_IsAdmin));
SELECT Username, Password, Email, IsAdmin FROM Users WHERE (Username = @Username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Email, IsAdmin FROM dbo.Users";
        ...
        public virtual int Delete(string Original_Username, string Original_Password, string Original_Email, bool Original_IsAdmin) {
        ...
        public virtual int Insert(string Username, string Password, string Email, bool IsAdmin) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Email, bool IsAdmin, string Original_Username, string Original_Password, string Original_Email, bool Original_IsAdmin) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Email, bool IsAdmin, string Original_Username, string Original_Password, string Original_Email, bool Original_IsAdmin) {
            return this.Update(Original_Username, Password, Email, IsAdmin, Original_Username, Original_Password, Original_Email, Original_IsAdmin);
        }
    }
