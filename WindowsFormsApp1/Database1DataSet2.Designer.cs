...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class CartDataTable : global::System.Data.TypedTableBase<CartRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CartRow AddCartRow(int ProductId, string ProductName, decimal ProductPrice, byte[] ProductImage) {
    ...
    public partial class CartTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cart] WHERE (([ProductId] = @Original_ProductId) AND ([Product" +
                "Name] = @Original_ProductName) AND ([ProductPrice] = @Original_ProductPrice))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cart] ([ProductId], [ProductName], [ProductPrice], [ProductIma" +
                "ge]) VALUES (@ProductId, @ProductName, @ProductPrice, @ProductImage);\r\nSELECT Pr" +
                "oductId, ProductName, ProductPrice, ProductImage FROM Cart WHERE (ProductId = @P" +
                "roductId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cart] SET [ProductId] = @ProductId, [ProductName] = @ProductName, [ProductPrice] = @ProductPrice, [ProductImage] = @ProductImage WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ([ProductPrice] = @Original_ProductPrice));
SELECT ProductId, ProductName, ProductPrice, ProductImage FROM Cart WHERE (ProductId = @ProductId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, ProductPrice, ProductImage FROM dbo.Cart";
        ...
        public virtual int Fill(Database1DataSet2.CartDataTable dataTable) {
        ...
        public virtual Database1DataSet2.CartDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.CartDataTable dataTable = new Database1DataSet2.CartDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.CartDataTable dataTable) {
        ...
        public virtual int Insert(int ProductId, string ProductName, decimal ProductPrice, byte[] ProductImage) {
        ...
        public virtual int Update(int ProductId, string ProductName, decimal ProductPrice, byte[] ProductImage, int Original_ProductId, string Original_ProductName, decimal Original_ProductPrice) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, decimal ProductPrice, byte[] ProductImage, int Original_ProductId, string Original_ProductName, decimal Original_ProductPrice) {
            return this.Update(Original_ProductId, ProductName, ProductPrice, ProductImage, Original_ProductId, Original_ProductName, Original_ProductPrice);
        }
    }
