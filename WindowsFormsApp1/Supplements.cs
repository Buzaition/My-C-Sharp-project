    ...
    public partial class Supplements : Form
    {
        ...
        private void populateItems()
        {
            try
            {
                ...
                int i = 0;
                Con.Open();
                SqlCommand cmd = new SqlCommand("Select ProductId,ProductName,ProductPrice,ProductImage from Items Where ProductType='Supplements'", Con);
                ...
                while (dr.Read())
                {
                    ...
                    SupPanel.Controls.Add(ListItems[i]);
                    i++;
