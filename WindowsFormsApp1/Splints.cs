...
{
    public partial class Splints : Form
    {
        public Splints()
        {
            InitializeComponent();
        ...
        private void populateItems()
        {
            try
            {
                ...
                int i = 0;
                Con.Open();
                SqlCommand cmd = new SqlCommand("Select ProductId,ProductName,ProductPrice,ProductImage from Items Where ProductType='Splints'", Con);
                ...
                while (dr.Read())
                {
                    ...
                    Splintspanal.Controls.Add(ListItems[i]);
                    i++;
